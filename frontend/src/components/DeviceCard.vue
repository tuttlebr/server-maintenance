...
h3 { margin: 14px 0 3px; font: 650 15px/1.2 var(--font-mono); }.device-identity { height: 18px; margin: 0 0 12px; color: var(--text-secondary); font-size: 12px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }.device-badges { display: flex; gap: 6px; margin-bottom: 14px; }
